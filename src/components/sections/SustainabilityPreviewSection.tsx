        ...
        <section className="relative bg-gradient-to-b from-background to-[#0a0a0a] py-24 md:py-32 overflow-hidden">
            ...
            <div className="container relative z-10 flex flex-col items-center text-center">
                ...
                <ScrollReveal delay={0.6} className="mt-12">
                    <Link href="/sustainability" className="group flex items-center gap-3 rounded-full border-2 border-primary/50 bg-transparent px-7 py-3.5 font-sans text-sm font-bold uppercase tracking-widest text-primary transition-all duration-300 hover:bg-primary hover:text-black hover:shadow-[0_0_30px_rgba(14,201,122,0.3)]">
