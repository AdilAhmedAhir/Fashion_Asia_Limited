        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="fixed inset-0 z-[999] flex flex-col justify-center bg-background px-6 sm:px-12"
                >
                    <nav className="flex flex-col gap-6">
                        {menuLinks.map((link, i) => (
                            ...
                            >
                                <Link href={link.href} onClick={onClose} className="group flex items-baseline gap-4">
